...
Computer Engineering graduate from San Jose State University (B.S., May 2025). Interested in hardware design, embedded systems, IoT, and machine learning.
...
- **IoT Smart Hub** — Home Assistant on Raspberry Pi with local voice assistant pipeline (Whisper + Piper + Ollama) and Matter device integration
